                    ...
                    <div class="box-body">
                        <div class="row" style="margin-bottom: 10px">
                            <div class="col-md text-center">
                                <form action="<?php echo site_url('frontend_pelanggan'); ?>" method="get" style="margin-top:10px">
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-btn">
                                            ...
                                            if ($q <> '') {
                                            ?>
                                                <a href="<?php echo site_url('frontend_pelanggan'); ?>" class="btn btn-default">Reset</a>
                                            <?php
                                            }
                                            ?>
                                ...
                                <div class="col-md-2 bg-white shadow p-4 m-2">
                                    <div class=" mx-auto rounded">
                                        ...
                                        <p style="font-size: 18px">
                                            ...
                                            <br>
                                            <a href="<?= base_url('pemesanan_pelanggan/tambahKeranjang/') . $produk->id_produk; ?>" class="btn btn-primary"><i class="fas fa-shopping-cart"></i> Keranjang</a>
                                        </p>
                                    </div>
                                </div>
